/**
 * ARISTA Management Panel - Unified Settings Engine (Sprint 16)
 * [MANAGES: GLOBAL SETTINGS, CONTACT, SOCIAL MEDIA, & BUSINESS HOURS]
 */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadGlobalSettings() {
        ...
        // Distribusikan nilai ke masing-masing input form
    ...
    // Aksi simpan (Ubah / Perbarui Data)
    form.addEventListener("submit", (e) => {
        ...
        // Simpan data struktur baru ke localStorage
